        ...
        do {
            ...
            switch (Integer.parseInt(checker[0])) {
                ...
                case 10: // show_backward
                    ...
                    break;
                case 11: // sort_merge
                    objlinklist.sort_merge();
                    break;
                case 12: // search_sequential
                    System.out.println(objlinklist.search_sequential(checker[1]));
                    break;
                case 13: // search_binary
                    System.out.println(objlinklist.search_binary(checker[1]));
                    break;
                case 14: // search_hashing
                    System.out.println(objlinklist.search_hashing(checker[1]));
                    break;
            }
