            ...
            if (checker.length > 0 && !checker[0].isEmpty()) {
                switch (Integer.parseInt(checker[0])) {
                    ...
                    case 12: // sort_merge
                        obj_arr.sort_merge();
                        break;
                    case 13: // search_sequential
                        System.out.println(obj_arr.search_sequential(checker[1]));
                        break;
                    case 14: // search_binary
                        System.out.println(obj_arr.search_binary(checker[1]));
                        break;
                    case 15: // search_hashing
                        System.out.println(obj_arr.search_hashing(checker[1]));
                        break;
                }
            }
